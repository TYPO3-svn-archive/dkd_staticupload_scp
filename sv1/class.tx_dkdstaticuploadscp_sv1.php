 ...
 ***************************************************************/
/**
* Service 'staticUpload: SCP' for the 'dkd_staticupload_scp' extension.
*
 ...
 *
 *
 *   47: class tx_dkdstaticuploadscp_sv1 extends t3lib_svbase
 ...
 */
	...
	class tx_dkdstaticuploadscp_sv1 extends t3lib_svbase {
		...
		var $extKey = 'dkd_staticupload_scp'; // The extension key.
	...
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dkd_staticupload_scp/sv1/class.tx_dkdstaticuploadscp_sv1.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dkd_staticupload_scp/sv1/class.tx_dkdstaticuploadscp_sv1.php']);
	}
